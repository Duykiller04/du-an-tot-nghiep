                            ...
                            <div class="row gy-4">
                                <div class="mt-3">
                                    ...
                                    <input type="text" class="form-control @error('name')is-invalid @enderror"
                                        name="name" id="name" value="{{ $storage->name }}">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="text" class="form-control @error('location')is-invalid @enderror"
                                        name="location" id="text" value="{{ $storage->location }}">
                                    <div class="invalid-feedback">
                                        @error('location')
                                            {{ $message }}
                                        @enderror
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex gap-2">
                        ...
                        <a class="btn btn-success" href="{{ route('admin.storage.index') }}"
                            class="btn btn-success mb-3">Quay lại</a>
                    </div><!-- end card header -->
                </div>
            </div>
            <!--end col-->
