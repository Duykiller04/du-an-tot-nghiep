...
@section('content')
    <div class="container-fluid">
        ...
        <form id="create-disease-form" method="POST" action="{{ route('admin.medicine.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <!-- Cột chính bên trái -->
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="medicine[medicine_code]"
