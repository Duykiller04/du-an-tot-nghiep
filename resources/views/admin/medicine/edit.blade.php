                        ...
                        <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <div class="row productNew mt-3">
                                        ...
                                        @foreach ($oldQuantities as $index => $quantity)
                                            <div class="row form-item unit-conversion-row" data-index="{{ $index }}">
                                                <div class="col-5 mt-3">
                                                    <label class="form-label" for="so_luong">Số lượng <span class="text-danger">(*)</span></label>
                                                    <input type="number" class="form-control" name="so_luong[]" value="{{ $quantity }}">
                                                </div>
                                                <div class="col-5 mt-3">
                                                    ...
                                                    <select name="don_vi[]" class="form-control">
                                                        ...
                                                        @foreach ($donvis as $donvi)
                                                            <option value="{{ $donvi['id'] }}" data-parent-id="{{ $donvi['parent_id'] }}"
                                                ...
                                                <div class="col-2 mt-3">
                                                    <button class="btn btn-danger btn-delete" type="button" style="margin-top: 25px" onclick="deleteUnit(this)">Xóa</button>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $medicine->packaging_specification }}" readonly>
    ...
    function updatePackagingSpecification() {
        ...
        quantities.forEach((quantityInput, index) => {
            ...
            if (quantityInput.value && unitSelect.value) {
                packagingSpec += `${quantityInput.value}-${unitSelect.options[unitSelect.selectedIndex].text}, `;
            }
        });

        document.getElementById('packaging_specification').value = packagingSpec.slice(0, -2); // Remove trailing comma
    }
